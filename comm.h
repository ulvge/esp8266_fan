...
typedef enum {
    ...
    UPDATE_TYPE_STATE_CHANGED = 2, // 状态改变时更新
...
typedef enum {
    ...
    POWER_STATE_IO_ON = powerCheckPin_active,  // 0
    POWER_STATE_IO_OFF = !powerCheckPin_active, // 1
} POWER_STATE_IO_t;
...
#define TOPIC_PCPowerCtrl "PCPowerCtrlDebug006"   // 控制电脑开关
